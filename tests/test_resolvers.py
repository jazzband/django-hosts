...
class ReverseTest(HostsTestCase):
    ...
    def test_reverse_custom_scheme(self):
        ...
        self.assertEqual(
            reverse("simple-direct", host="scheme", scheme="ftp"),
    ...
    def test_reverse_custom_port(self):
        ...
        self.assertEqual(
            reverse("simple-direct", host="port", port="1337"),
    ...
    def test_reverse_with_query(self):
        self.assertEqual(
            reverse("simple-direct", host="blank_or_www", query={"spam": "eggs"}), "//example.com/simple/?spam=eggs"
        )
...
class UtilityTests(HostsTestCase):
    ...
    def test_get_host(self):
        ...
        self.assertRaisesMessage(
            NoReverseMatch,
            "No host called 'non-existent' exists",
            get_host,
            "non-existent",
        )
