...
class MiddlewareTests(HostsTestCase):
    def test_missing_hostconf_setting(self):
        self.assertRaisesMessage(
            ImproperlyConfigured, "Missing ROOT_HOSTCONF setting", HostsRequestMiddleware, get_response_empty
        )

    @override_settings(ROOT_HOSTCONF="tests.hosts.simple")
    def test_missing_default_hosts(self):
        self.assertRaisesMessage(
            ImproperlyConfigured, "Missing DEFAULT_HOST setting", HostsRequestMiddleware, get_response_empty
        )

    @override_settings(ROOT_HOSTCONF="tests.hosts.simple", DEFAULT_HOST="boo")
    ...
    @override_settings(ALLOWED_HOSTS=["other.example.com"], ROOT_HOSTCONF="tests.hosts.simple", DEFAULT_HOST="www")
    ...
    @override_settings(
        ALLOWED_HOSTS=["ss.example.com"], ROOT_HOSTCONF="tests.hosts.simple", DEFAULT_HOST="with_view_kwargs"
    )
    ...
    @override_settings(
        ALLOWED_HOSTS=["spam.eggs.example.com"], ROOT_HOSTCONF="tests.hosts.multiple", DEFAULT_HOST="multiple"
    )
