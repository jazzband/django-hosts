...
class HostTests(HostsTestCase):
    ...
    def test_host_nonexistent_callback(self):
        api_host = host(
            r"api", "api.urls", name="api", callback="whatever.non_existent"
        )
        ...
        api_host = host(
            r"api", "api.urls", name="api", callback="django_hosts.non_existent"
        )
        self.assertRaisesMessage(
            ImproperlyConfigured,
        ...
        api_host = host(
            r"api", "api.urls", name="api", callback="tests.broken_module.yeah_yeah"
        )
