...
latex_documents = [
    ("index", "django-hosts.tex", "django-hosts Documentation", "Jannis Leidel and contributors", "manual"),
]
...
man_pages = [("index", "django-hosts", "django-hosts Documentation", ["Jannis Leidel and contributors"], 1)]
